...
class Corso_emissions:
    ...
    def get_emission(self, id, specie, date, interpolate_month=True):
        ...
        dfs = self.df_emiss[self.df_emiss.index == id]

        # Get time profile IDs.
        id_month = dfs['ID_MonthFact'].iloc[0]
        id_week  = dfs['ID_WeekFact'].iloc[0]
        id_hour  = dfs['ID_HourFact'].iloc[0]
        ...
        emiss_y = dfs[f'{specie}_kty'].iloc[0] * 10**6
    ...
    def get_profile(self, id):
        ...
        # Get time profile IDs.
        id_prof = dfs['ID_VertProf'].iloc[0]
